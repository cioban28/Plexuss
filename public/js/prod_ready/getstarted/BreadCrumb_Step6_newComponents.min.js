...
var GetStarted_Step6new_Component = React.createClass({displayName: "GetStarted_Step6_Component",
	getInitialState: function(){
		return {
			...
			React.createElement("div", {className: "step_container"},
				React.createElement("div", {className: "row phone-container"},
					React.createElement("div", {className: "column small-12"},
						React.createElement("form", {onSubmit:  this._save},
							React.createElement("input", {type: "hidden", name: "step", value: 6 }),
                ...
                React.createElement("div", {className: "columns small-12 medium-1"}, ""),
  							...
  							React.createElement("div", {className: "columns small-11 medium-11"},
  								React.createElement("label", {htmlFor: "_intrest"}, 'I am intrested in financial aid, grants and scholarships')
  							),
...
ReactDOM.render( React.createElement(GetStarted_Step6new_Component, null), document.getElementById('get_started_step6_new') );
