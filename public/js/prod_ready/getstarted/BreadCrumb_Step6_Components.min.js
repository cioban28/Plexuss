...
(function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
        ...
        var percentage, styles = {
            ...
            GetStarted_Step6_Component = React.createClass({
                displayName: "GetStarted_Step6_Component",
                getInitialState: function() {
                    return {
                ...
                _validate: function(e) {
                    ...
                    switch (n) {
                        ...
                        case "city":
                            ...
                            break;
                        case "country":
                            1 === +s ? (t = !0, this.state.state || (this.state._stateValid = !1, this.state._stateValidated = !0)) : s && (t = !0), s = +s;
                            break;
                        case "state":
                            1 === this.state.country ? s && (t = !0) : t = !0;
                            break;
                        case "zip":
                            t = !!s && !!/^[a-zA-Z0-9\.,\- ]+$/.test(s);
                            break;
                        case "code":
