...
(function(window) {
  ...
  Player = function(playerNode) {
    ...
    function makeSound(url) {
      ...
      var sound = soundManager.createSound({
        ...
        onerror: function() {
          ...
          /* Below causes unwanted behavior, makes player from other profiles to not work after an error occurs */
    ...
    function playLink(link) {
      ...
      if (soundManager.canPlayMIME(link.type)) {
