		...
		return (
			<div className="step_container">
				<div className="row">
					...
					<div className="columns small-12 medium-5 intl-std-msg">
						<div className="promo-msg intl-msg">
							<div>Important notice to International Students</div>
							<div>{'If you are interested in attending universities in the United States or Internationally, you will need to provide financial documents. After you complete this signup process you will receive an email with instructions on how to upload your financial documents.'}</div>
						</div>
					</div>
				</div>
