...
var GetStarted_Step4_Component = React.createClass({displayName: "GetStarted_Step4_Component",
	...
	componentWillMount: function(){
        ...
        fbq('track', 'GetStarted_Step4_FinancialContribution_New_Page');
		...
		return (
			React.createElement("div", {className: "step_container"}, 
				React.createElement("div", {className: "row"}, 
					...
					React.createElement("div", {className: "columns small-12 medium-5 intl-std-msg"}, 
						React.createElement("div", {className: "promo-msg intl-msg"}, 
							React.createElement("div", null, "Important notice to International Students"), 
							React.createElement("div", null, 'If you are interested in attending universities in the United States or Internationally, you will need to provide financial documents. After you complete this signup process you will receive an email with instructions on how to upload your financial documents.')
						)
					)
				), 
