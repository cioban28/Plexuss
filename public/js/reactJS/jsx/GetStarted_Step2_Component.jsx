...
var GetStarted_Step2_Component = React.createClass({
	...
	render: function(){
		...
		return (
			<div className="step_container">
				{ user && !_.isEmpty(user) && !user.email ? <GetEmail data={this.state} setEmail={this._setEmail} /> : null }
	 			{
...
var GetEmail = React.createClass({
	getInitialState: function(){
		return {
			email: '',
			emailValid: false,
	...
	render: function(){
		return (
			<div className="form-container">
				...
				<div className="f-input">
					<select name={this.props.name} className="is-input" 
...
ReactDOM.render( <Provider store={store}><GetStarted_Step2_Component  /></Provider>, document.getElementById('get_started_step2') );