...
import {sortCol, getScholarships, getAllCountries, getAllStates, getAllDepartments, getAllMilitaries, getAllEthnicities, getAllReligionsCustom, getAllProviders, deleteScholarship, getAllDates,getAllMajorDepartments} from './../../../actions/scholarshipsActions';
...
class SchTable extends React.Component{
	...
	componentWillMount(){
		...
		dispatch(getAllMilitaries());
		dispatch(getAllEthnicities());
		dispatch(getAllReligionsCustom());
		dispatch(getAllDates());
		dispatch(getAllMajorDepartments());
	}
	...
	render(){
		...
		return(
			<div className="_schTable">
				...
				{editModal &&
					<EditModal item={editItem} close={() => this.setState({editModal: false})} />}
