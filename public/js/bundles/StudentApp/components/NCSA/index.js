...
//Main Component
class NCSA extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            displayModal: false,
            ...
            sports: NCSA_SPORTS,
            gradYears: ['2020','2021','2022', '2023', '2024', '2025'],
            ...
            <div id="ncsa">
                <div className="ncsa-main">                    
                    ...
                    <div className="small-12 large-9 column">
                        {/* Mobile Apply */} 
                        <div className="mobile-apply" onClick={() => this.showModal(_user)}>Apply Now</div>
                        ...
                        <div className="small-12 column ncsa-content">
                            ...
                            <p>All student-athletes looking to compete in their desired sport at the college level. You can learn more about NCSA by applying <span className="here" onClick={() => this.showModal(_user)}>here</span>
                            </p>
                    ...
                    {/* Right Side - Engage and SignUp */} 
                    <div className="small-12 large-3 column">
                        <Engage className="ncsa-engage">
                            <div className="ncsa-apply" onClick={() => this.showModal(_user)}>Apply Now</div>
                        </Engage>

                        <div className="small-12 column plexuss-signup">
                            <div className="signup-text">Sign up & get your college application fee waived!</div>
                            <div className="signup-btn" onClick={this.redirectToSignUp}>Sign Up</div>
                        </div>
                    </div>
                </div>
...
// if(document.getElementById('ncsa')){
//     ReactDOM.render(<NCSA />, document.getElementById('ncsa'));
// }
