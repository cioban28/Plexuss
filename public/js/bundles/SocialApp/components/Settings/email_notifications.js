...
class Email_notifications extends Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    updateComponent(){
        ...
        if(setting_notification && setting_notification.email && setting_notification.email.all_school_notifications){
            this.setState({
                schoolNotification: setting_notification.email.all_school_notifications,
        ...
        else if(setting_notification && setting_notification.email){
            this.setState({
                schoolRecruitYou: setting_notification.email.wants_to_recruit_you === undefined ? true : setting_notification.email.wants_to_recruit_you,
                schoolViewedYou: setting_notification.email.viewed_your_profile === undefined ? true : setting_notification.email.viewed_your_profile,
                sentAMessage: setting_notification.email.sent_you_a_message === undefined ? true : setting_notification.email.sent_you_a_message,
                handshakes: setting_notification.email.handshakes_with_colleges === undefined ? true : setting_notification.email.handshakes_with_colleges,
            })
        }

        if(setting_notification && setting_notification.email && setting_notification.email.all_plexuss_notifications){
            this.setState({
                plexussNotification: setting_notification.email.all_plexuss_notifications,
                stateUpdate: true,
                newsUpdate: true,
                otherUpdate: true,
            })
            ...
            this.setState({
                stateUpdate: setting_notification.email.college_stats_updates === undefined ? true : setting_notification.email.college_stats_updates,
                newsUpdate: setting_notification.email.college_news_updates === undefined ? true : setting_notification.email.college_news_updates,
                otherUpdate:  setting_notification.email.other_plexuss_notifications === undefined ? true : setting_notification.email.other_plexuss_notifications,
            })
        }
    }
        ...
        return(
            <div className="large-9 medium-9 small-12 upper_container columns">
                <div className="setting_content_container">
                    <Header imgSrc={'/social/images/settings/active_options/envelope.png'} title={'EMAIL NOTIFICATIONS'} imgClass={'email_notification'} backClickHandler={this.props.backClickHandler} />
                    <div className="content_container">
                        <div className="explanation">
                            Manage your email notifications below. Click 'Details' to expand further to have more control over each type of notification.
                        </div>
                        ...
                        <Notification_switch text={'Plexuss Notifications'} id={'icon-switch2'} htmlFor={'normal-switch2'} checked={this.state.plexussNotification} handleChange={this.hanldlePlexussNotification} handleDetail={this.hanldlePlexussNotificationDetail} subOpen={this.state.openPlexussNotificationDetaile}/>
                        {
...
export default connect(mapStateToProps, null)(Email_notifications)
