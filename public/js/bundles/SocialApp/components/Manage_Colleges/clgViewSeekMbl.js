...
class CollegeViewSeek extends Component{
    constructor(props){
        super(props);
        this.state={
            collegDetails: [],
    ...
    render(){
        let { colleges, selected, handleSelectCheck, openModal, loadSpinner, handleSingleDelete } = this.props;
        return(
            <div className="favorite_colleges_mbl_view">
                ...
                }
                {
                    colleges && colleges.map((college, index) => {
                        return <SingleColleg key={index} college={college} getCollegeData={this.getCollegeData} collegDetails={this.state.collegDetails} handleSelectCheck={handleSelectCheck} selected={selected} openModal={openModal} handleSingleDelete={handleSingleDelete}/>
                    })
                }
            </div>
        )
...
class SingleColleg extends Component{
    ...
    render(){
        let { college, getCollegeData, collegDetails, handleSelectCheck, selected, openModal, handleSingleDelete } = this.props;
        return(
            <div className="college_card">
                ...
                <div className="want_of_clg">
                    <div className="ques">WANT TO BE RECRUITED?</div>
                    <div className="yes_no_btn">
                        <div className="yes_btn" onClick={() => openModal(college.college_id)}>YES</div>
                        <div className="no_btn" onClick={() => handleSingleDelete(college.college_id)}>NO</div>
                    </div>
                </div>
...
export default CollegeViewSeek;
