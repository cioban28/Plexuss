...
class RecruitmentModal extends Component {
  ...
  handleSubmit(e) {
    e.preventDefault();
    this.props.saveRecruitMeInfo(this.props.collegeId, {...this.state});
  }
  ...
  render() {
    ...
    return (
      <form id='recruitmeModal1' onSubmit={this.handleSubmit}>
      {
        !!Object.entries(getRecruited).length &&
          <div className="model-inner-div regularRecruitme">
            ...
            <div>
              ...
              <div className="row">
                <div className="column small-12  large-6 leftRecruitForm">
                    <div className="row">
                        <div className="applyTitle small-12 column">SELECT ALL THAT APPLY</div>
                    </div>
                    <div className="row">
                ...
                <div className="small-12 medium-12 large-6  column rightRecruitCompare">
                    <div className="row">
                        <div className="compareTitle column small-12">COMPARE YOUR SCORES TO THEIRS</div>
                    </div>
                    <div className="row">
            ...
            <div className="row">
                <div className="column large-5 medium-6 small-10 small-centered text-center">
                    <input type='submit' onSubmit={this.handleDontTakeToPortalClick} className='btn green-btn' style={{cursor: 'pointer', marginTop: '20px', marginBottom: '4px'}} value='Ok' />
                </div>
            </div>

            <div className="row">
                <div className="column large-5 medium-6 small-10 small-centered text-center">
                    <input type='submit' onSubmit={this.handleSubmit} className='btn white-btn' style={{cursor: 'pointer', marginTop: '20px', marginBottom: '4px'}} value='View my list' />
                </div>
            </div>
