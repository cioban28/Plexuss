...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'scholarship' => [
            ...
            \App\Http\Middleware\VerifyCsrfToken::class,
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
            \App\Http\Middleware\ScholarshipAuth::class,
        ],
        ...
        'agency' => [
            ...
            \App\Http\Middleware\VerifyCsrfToken::class,
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
            \App\Http\Middleware\AgencyAuth::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'auth.agency' => \App\Http\Middleware\AgencyAuth::class,
        'auth.scholarship' => \App\Http\Middleware\ScholarshipAuth::class,
