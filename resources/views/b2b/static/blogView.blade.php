...
@section('b2b-content')
	...
	<div class="b2b-9row b2bsub-top text-center">
		...
		<div class="blog-nav">
			...
			<ul class="blog-menu">
				<li class="get-blog-from-blog @if($blog_section == 'blog')  active @endif">BLOG</li>
				<li class="press-btn  @if($blog_section == 'press')  active @endif ">PRESS RELEASES</li>
...
<script>
	if (typeof history.pushState != "undefined") {
				...
				var stateObj = {page: 'blog-view', slug: '', url: window.location.pathname};
