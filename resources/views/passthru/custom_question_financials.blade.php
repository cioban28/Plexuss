                    ...
                    @if(isset($user) || $user != '')
                        ...
                        <form id="missing-field-form" method="post" action="/saveMissingFields">
                            ...
                            <div class="form-group">
                                <label for="financial_firstyr_affordibility">How much can you pay towards your college education during the first year?</label>
                                <select class="form-control" name="financial_firstyr_affordibility" id="financial_firstyr_affordibility" title="Financial affordibility is required" required>
                            ...
                            <input type="hidden" name="section" value="custom_question_financials">
