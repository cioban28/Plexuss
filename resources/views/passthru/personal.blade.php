                        ...
                        <form id="missing-field-form" method="post" action="/saveMissingFields">
                            ...
                            @if (!isset($user_type) || $user_type == '')
                                <div class="form-group">
                                    <label for="gender">I am a(n)...</label>
                                    <select class="form-control" name="user_type" id="user_type" title="User type is required" required>
                            ...
                            @if ($user['in_college'] == '')
                                <div class="form-group">
                                    <label for="in_college">What is your current level of education?</label>
                                    <select class="form-control" name="in_college" id="in_college" title="Education level is required" required>
                                        <option value="">Select one...</option>
                            ...
                            @if (!isset($user['current_school_id']) || $user['current_school_id'] == '')
                                <div class="form-group">
                                    <label for="school_name">Name of school?</label>
                                    <input id='school_name' name='school_name' class="form-control" title="School name required" required>
                                </div>
                            @endif
                            ...
                            @if ($user['gender'] == '')
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="gender" id="gender" title="Gender name is required" required>
                                        <option value="">Select one...</option>
                            ...
                            @if (!isset($grad_year) || $grad_year == '')
                                <div class="form-group">
                                    <label for="grad_year">When will you be graduating?</label>
                                    <select class="form-control" name="grad_year" id="grad_year" title="Graduation year is required" required>
                                        <option value="">Select one...</option>
                                        <?php 
                                            $currentYear = date("Y");

                                            $lowerLimit = ($currentYear - 50);
                                            $upperLimit = ($currentYear + 50);
                                        ?>
