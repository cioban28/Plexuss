<?php 
    ...
    if (isset($user['financial_firstyr_affordibility'])) {
        switch ($user['financial_firstyr_affordibility']) {
            case '0.00':
                $financial_label = '$0';
                break;

            case '0 - 5,000':
                $financial_label = '$0 - $5,000';            
                break;
            case '5,000 - 10,000':
                $financial_label = '$5,000 - $10,000';
                break;

            case '10,000 - 20,000':
                $financial_label = '$10,000 - $20,000';
                break;
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 unqualified_container">
                <div class="para unqualified_message financials_unqualified_message">
                    Although <span>{{$financial_label}}</span> may not be enough for applying to <span>{{$ad_redirect_campaigns['label']}}</span>. You may qualify for other universities.
                </div>

                <div class="para unqualified_message financials_unqualified_message">
                    Please complete the next steps to discover programs that you may qualify for.
                </div>

                <div class='text-center'>
                    <a href={{$plexuss_application_link}}>
                        <div class='plexuss-application-next-button'>Next</div>
                    </a>
                </div>
