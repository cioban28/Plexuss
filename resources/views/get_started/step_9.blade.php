...
@section('content')
  <div id="get_started_step9" class="gs_step" data-step="{{$currentStep}}">
        ...
        <div class="main-body">
            ...
            <form class="checkmark-form">
                ...
                <div class="next-btn-container">
                  <a href="#" onclick="validateNumber();" class="next-btn">Next</a>
                </div>
            </form>
        </div>
    </div>
    ...
    function validateNumber(){
        if(errorInNumber == ''){
          ...
          $.ajax({
            ...
            window.location.replace("/checkout/premium") 
          });
        }else{
          return false;
        }
