<?php
    ...
    $undergradData = isset($undergrad_grad_data) ? $undergrad_grad_data : null;
...
<?php 
    $header = isset($undergradData['header_info']['grad']) ? $undergradData['header_info']['grad'] : null;
    ...
    <div class='column small-12'>
        <div style='display:block;'>
            ...
            <div class="row university-stats-content">
                <div class="large-12 columns no-padding bg-ext-black radial-bdr clearfix">
                    
                    <div class="large-6 columns college-rank-divide clearfix">
                       
                        <div class='small-12 column university-content-admis-headline1'>
                            ANNUAL INTERNATIONAL COSTS
                        </div>
                      
                        @if(isset($college_data_custom_tuition))
                        @foreach($college_data_custom_tuition as $k)
                        <div class='row'>
                        ...
                        @if(isset($header['grad_total_yearly_cost']))
                        <div class="detail-university-grey"><span class="bigger">TOTAL YEARLY COSTS</span></div>
                        <div class="detail-university-green-content">

                                ${{number_format($header['grad_total_yearly_cost'])}} 
                        </div>
                        <br /><br />
                        @endif

                        @if(isset($header['grad_tuition']))
                        <div class="detail-university-grey">TUITION</div>
                        <div class="detail-university-green-content">
                            
                                ${{number_format($header['grad_tuition'])}}    
                        </div>
                        @endif


                         @if(isset($header['grad_room_board']))
                        <div class="detail-university-grey">ROOM &amp; BOARD</div>
                        <div class="detail-university-green-content">
                           
                                ${{number_format($header['grad_room_board'])}} 
                        </div>
                        @endif


                        @if(isset($header['grad_book_supplies']))
                        <div class="detail-university-grey">BOOKS &amp; SUPPLIES</div>
                        <div class="detail-university-green-content">
                            
                                ${{number_format($header['grad_book_supplies'])}} 
                        </div>
                        @endif
...
<?php 
    $admission = isset($undergradData['admission_info']['grad']) ? $undergradData['admission_info']['grad'] : null;
    $scholarship = isset($undergradData['scholarship_info']['grad']) ? $undergradData['scholarship_info']['grad'] : null;
?>
<div class="row mt15">            
    ...
    <div class="column box-div small-12 large-4 clearfix" id="admission_box">
        <div class="bg-ext-black radial-bdr inner-cont">
            ...
            @if(isset($admission['grad_application_deadline']))
            <div class="detail-university-grey">APPLICATION DEADLINE</div>
            <div class="detail-university-green-content">
                @if( $admission['grad_application_deadline'] == 'rolling_admissions' )
                    {{ 'Rolling Admissions' }}
                @else
                    {{$admission['grad_application_deadline']}}
                @endif
            </div>
            @endif
            <br />
             ...
             @if($admission['grad_admissions_available'])
            <div class="detail-university-grey">CONDITIONAL ADMISSIONS AVAILABLE</div>
            <div class="detail-university-green-content">
                {{ ucfirst($admission['grad_admissions_available']) }}
            </div>
            <br/><br/>  
            @endif


            @if(isset($admission['grad_application_fee']))
            <div class="row">
                ...
                <div class="column small-6 detail-university-green-content right-col-addmissions">
                    ${{number_format($admission['grad_application_fee'])}}
                </div>
            </div>
            @endif

            @if(isset($admission['grad_num_of_applicants']))
            <div class="row">
                <div class="column small-6 detail-university-grey left-col-addmissions"># OF APPLICANTS</div>
                <div class="column small-6 detail-university-green-content right-col-addmissions">
                    {{$admission['grad_num_of_applicants']}}
                </div>
            </div>
            @endif

            @if(isset($admission['grad_num_of_admitted']))
            <div class="row">
                <div class="column small-6 detail-university-grey left-col-addmissions"># ADMITTED</div>
                <div class="column small-6 detail-university-green-content right-col-addmissions">
                    {{$admission['grad_num_of_admitted']}}
                </div>
            </div>
            ...
            <div class="row">
                <div class="column small-6 detail-university-grey left-col-addmissions">% ADMITTED</div>
                <div class="column small-6 detail-university-green-content right-col-addmissions">
                    {{ ceil( 100* ($admission['grad_num_of_admitted']/ $admission['grad_num_of_applicants']) ) }}%
                </div>
            </div>
            @endif


            @if(isset($admission['grad_num_of_admitted_enrolled']))
            <div class="row">
                <div class="column small-6 detail-university-grey left-col-addmissions"># ADMITTED & ENROLLED</div>
                <div class="column small-6 detail-university-green-content right-col-addmissions">
                    {{$admission['grad_num_of_admitted_enrolled']}}
                </div>
            </div>
            ...
            <div class="row">
                <div class="column small-6 detail-university-grey left-col-addmissions">% ADMITTED & ENROLLED</div>
                <div class="column small-6 detail-university-green-content right-col-addmissions">
                    {{ ceil( 100* ($admission['grad_num_of_admitted_enrolled']/ $admission['grad_num_of_applicants']) ) }}%
                </div>
            </div>
            @endif
        </div>
    ...
    {{-- @if (isset($scholarship) && isset($scholarship['grad_scholarship_available']) && $scholarship['grad_scholarship_available'] !== 'unknown') --}}
    @if(false)
    ...
    <div class="box-div column small-12 large-4" id="scholarship_box">
        <div class="bg-ext-black radial-bdr inner-cont">
            ...
            @if(isset($scholarship['grad_scholarship_available']))
            <div class="detail-university-grey">Scholarship(s) Available</div>
            <div class="detail-university-green-content">
                {{ucfirst($scholarship['grad_scholarship_available'])}}
            </div>
            @endif


            @if(isset($scholarship['grad_scholarship_student_received_aid']))
             <div class="row">
                ...
                <div class="column small-5 detail-university-green-content right-col-addmissions">
                    {{$scholarship['grad_scholarship_student_received_aid']}}%
                </div>
            </div>
            @endif


            @if(isset($scholarship['grad_scholarship_avg_financial_aid_given']))
            <div class="row">
                <div class="column small-7 detail-university-grey left-col-addmissions">Avg. Financial aid given</div>
                <div class="column small-5 detail-university-green-content right-col-addmissions">
                    ${{number_format($scholarship['grad_scholarship_avg_financial_aid_given'])}}
                </div>
            </div>
            @endif


            @if(isset($scholarship['grad_scholarship_requirments']))
            <div class="university-content-admis-head3">SCHOLARSHIP REQUIREMENTS</div>
            <div class="detail-university-green-content-smaller">
                {{$scholarship['grad_scholarship_requirments']}}
            </div>

            @if(isset($scholarship['grad_scholarship_gpa']))
            <div class="university-content-admis-head5">GPA</div>
            <div class="detail-university-green-content">
                {{$scholarship['grad_scholarship_gpa']}}
            </div>
            @endif

            @if(isset($scholarship['grad_scholarship_link']))
            <div class="university-content-admis-head5">LINK FOR MORE INFO</div>
            <div class="detail-university-little-link">
                <a  href="{{$scholarship['grad_scholarship_link']}}" target="_blank">
                    {{$scholarship['grad_scholarship_link']}}
                </a>
            </div>
    ...
    <?php 
        $grad = isset($undergradData['requirements']['grad']) ?  $undergradData['requirements']['grad'] : null;
        $both = isset($undergradData['requirements']['both']) ? $undergradData['requirements']['both']: null;
    ?>
        <!-- academic -->
    <div class="column small-12 large-8" id="academic_col">
        <div class="row requirements-title">ACADEMIC REQUIREMENTS</div>
        <div class="bg-pure-white v-f-a-content" id="int_academic_cont" style="min-height: 360px;">
            ...
            @if(isset($grad['academic']))
            @foreach($grad['academic'] as $key)
            <div class="row">
                <div class="column @if(isset($key['attachment_url']) && !empty($key['attachment_url'])) small-7 @else small-12 @endif text-left">
                    {{$key['title'] or ''}}
                    <div class="download-desc">{{$key['description'] or ''}}</div>
...
<?php 
    $grades = isset($undergradData['grade_exams']['grad']) ? $undergradData['grade_exams']['grad'] : null;
?>
<div class="row">    
    <div class="column small-12" id="grades_exams_requirement_table">
        ...
        <div id="grades_exams_table_body">
            <div class="grades-exams-row">
                ...
                <div class="row" id="gpa_row">
                    ...
                    <div class="column small-3 large-3 sub-title-col">
                        @if(isset($grades['grad_grade_gpa_min']))
                            {{$grades['grad_grade_gpa_min'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 sub-title-col">
                         @if(isset($grades['grad_grade_gpa_avg']))
                            {{$grades['grad_grade_gpa_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
            ...
            @if (isset($grades['grad_grade_toefl_min']) || isset($grades['grad_grade_toefl_avg']) || isset($grades['grad_grade_ielts_min']) || isset($grades['grad_grade_ielts_avg']))
            <div class="grades-exams-row" id="english_row">
                ...
                <div class="row">
                    ...
                    <div class="column small-3 large-3 ger-min-col">
                         @if(isset($grades['grad_grade_toefl_min']))
                            {{$grades['grad_grade_toefl_min'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 ger-avg-col">
                        @if(isset($grades['grad_grade_toefl_avg']))
                            {{$grades['grad_grade_toefl_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="column small-3 large-3 ger-min-col">
                        @if(isset($grades['grad_grade_ielts_min']))
                            {{$grades['grad_grade_ielts_min'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 ger-avg-col">
                        @if(isset($grades['grad_grade_ielts_avg']))
                            {{$grades['grad_grade_ielts_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
            ...
            @if (isset($grades['grad_grade_act_composite_min']) || isset($grades['grad_grade_act_composite_avg']) || isset($grades['grad_grade_act_math_min']) || isset($grades['grad_grade_act_math_avg']) || isset($grades['grad_grade_act_english_min']) || isset($grades['grad_grade_act_english_avg']))
            <div class="grades-exams-row" id="act_row">
                ...
                <div class="row">
                    ...
                    <div class="column small-3 large-3 ger-min-col">
                        @if(isset($grades['grad_grade_act_composite_min']))
                            {{$grades['grad_grade_act_composite_min']or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 ger-avg-col">
                        @if(isset($grades['grad_grade_act_composite_avg']))
                            {{$grades['grad_grade_act_composite_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="column small-3 large-3 ger-min-col">
                        @if(isset($grades['grad_grade_act_math_min']))
                            {{$grades['grad_grade_act_math_min'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 ger-avg-col">
                        @if(isset($grades['grad_grade_act_math_avg']))
                            {{$grades['grad_grade_act_math_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="column small-3 large-3 ger-min-col">
                        @if(isset($grades['grad_grade_act_english_min']))
                            {{$grades['grad_grade_act_english_min'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 ger-avg-col">
                        @if(isset($grades['grad_grade_act_english_avg']))
                            {{$grades['grad_grade_act_english_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
            ...
            @if (isset($grades['grad_grade_sat_math_min']) || isset($grades['grad_grade_sat_math_avg']) || isset($grades['grad_grade_sat_reading_min']) || isset($grades['grad_grade_sat_reading_avg']))
            <div class="grades-exams-row" id="sat_row">
                ...
                <div class="row">
                    ...
                    <div class="column small-3 large-3 ger-min-col">
                        @if(isset($grades['grad_grade_sat_math_min']))
                            {{$grades['grad_grade_sat_math_min'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 ger-avg-col">
                        @if(isset($grades['grad_grade_sat_math_avg']))
                            {{$grades['grad_grade_sat_math_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="column small-3 large-3 ger-min-col">
                        @if(isset($grades['grad_grade_sat_reading_min']))
                            {{$grades['grad_grade_sat_reading_min'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 ger-avg-col">
                        @if(isset($grades['grad_grade_sat_reading_avg']))
                            {{$grades['grad_grade_sat_reading_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
            ...
            @if (isset($grades['grad_grade_gre_writing_min']) || isset($grades['grad_grade_gre_writing_avg']) || isset($grades['grad_grade_gre_verbal_min']) || isset($grades['grad_grade_gre_verbal_avg']) || isset($grades['grad_grade_gre_quant_min']) || isset($grades['grad_grade_gre_quant_avg']))
            <div class="grades-exams-row" id="gre_row">
                ...
                <div class="row">
                    ...
                    <div class="column small-3 large-3 ger-min-col">
                        @if(isset($grades['grad_grade_gre_writing_min']))
                            {{$grades['grad_grade_gre_writing_min'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 ger-avg-col">
                        @if(isset($grades['grad_grade_gre_writing_avg']))
                            {{$grades['grad_grade_gre_writing_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="column small-3 large-3 ger-min-col">
                        @if(isset($grades['grad_grade_gre_verbal_min']))
                            {{$grades['grad_grade_gre_verbal_min'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 ger-avg-col">
                        @if(isset($grades['grad_grade_gre_verbal_avg']))
                            {{$grades['grad_grade_gre_verbal_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="column small-3 large-3 ger-min-col">
                        @if(isset($grades['grad_grade_gre_quant_min']))
                            {{$grades['grad_grade_gre_quant_min'] or ''}}
                        @else
                            -
                        @endif
                    </div>
                    <div class="column small-3 large-3 ger-avg-col">
                        @if(isset($grades['grad_grade_gre_quant_avg']))
                            {{$grades['grad_grade_gre_quant_avg'] or ''}}
                        @else
                            -
                        @endif
                    </div>
...
@endif
 ...
 <?php 
    ...
    $grad = isset($undergradData['additional_notes']['grad']) ? $undergradData['additional_notes']['grad']: null;
?>
@if (isset($both) || isset($grad))
<div class="box-div column small-12 mt15 large-4">
    <div class="bg-pure-white mt15 radial-bdr inner-cont"  id="additoinal_notes_box">
...
@if( isset($grad) || isset($both) )
<div class="row mt15 clearfix"  id="visa_fin_acad_sec">
    
    <div class="column small-12 @if(isset($undergradData['additional_notes']['both']) || isset($undergradData['requirements']['both'])) large-6 @else large-8 @endif" id="visa-fin-container">

        <!-- visa -->
        @if(isset($both['visa']) || isset($grad['visa']))
        ...
        <!-- financial -->
        @if(isset($both['financial']) || isset($grad['financial']))
        ...
        <div class="bg-pure-white v-f-a-content" id="fin_req_cont">
            ...
            @if(isset($grad['financial']))
            @foreach($grad['financial'] as $key)
            <div class="row">
                <div class="column @if(isset($key['attachment_url']) && !empty($key['attachment_url'])) small-7 @else small-12 @endif text-left">
                    {{$key['title'] or ''}}
                    <div class="download-desc">{{$key['description'] or ''}}</div>
         ...
         <div class=" row owl-int-alumni-carousel owl-carousel owl-theme bg-pure-white" id="int_alumni_cont">
            ...
            <div class="item">
                <div class="int-alumni-cont">
                    ...
                    @if( $key['linkedin'] )
                        <div class="intl-linkedin">
                            <a href="{{$key['linkedin']}}">in</a>
                        </div>
                    @endif
                </div>
            </div>
