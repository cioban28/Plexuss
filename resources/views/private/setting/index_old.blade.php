        ...
        <div class="column small-12">
            ...
            <div class="row password-change-form">
                <div class="column small-11 small-centered">
                   ...
                   {{ Form::open(array('url' => "setting/accountSetting/". null,'method' => 'POST', 'name'=>'accountSettingsChangePass','id' => 'accountSettingsChangePass','data-abide'=>'ajax')) }}
                    ...
                    <div class='row'>
                        ...
                        <div class="column small-12 medium-9">
                            {{ Form::password('old_pass', array('id'=>'old_pass','placeholder'=>'', 'class'=>'','required', 'pattern' => 'passwordpattern')) }}
                    ...
                    <div class='row'>
                        ...
                        <div class="column small-12 medium-9">
                            {{ Form::password('new_pass', array('id'=>'new_pass','placeholder'=>'', 'class'=>'','required', 'pattern' => 'passwordpattern')) }}
                    ...
                    <div class='row'>
                        ...
                        <div class="column small-12 medium-9">
                            {{ Form::password('verify_pass', array('id'=>'verify_pass','placeholder'=>'', 'class'=>'','required', 'pattern' => 'passwordpattern','data-equalto'=>'new_pass')) }}
                            ...
                            <div class="row invite-via-title-link">
                                ...
                                <div class="row select-all-users-checkbox-row">
                                    <div class="column small-8 medium-6">
                                        ...
                                        {!! Form::label('select_all_from_fb', 'Select All <span class="contact-list-count"> &nbsp;</span>') !!}
                                    </div>
            ...
            <div class="row collapse payment-info-title">
                ...
                <div class="column small-6 text-right">
                    <div class="billing-tabs">
                        <span class="bill-tab active" data-bill-tab="default">Billing</span> &nbsp;
                        <span class="bill-tab" data-bill-tab="history">Invoice History</span>
                    </div>
                </div>
                <div class="back-to-plans-btn column small-12"><small>Back to plans</small></div>
            </div>

            <div class="row collapse billing-container">
                <div class="column small-12 payment-info-container billing-section default">

                    <div class="billing-package-options">
                        <div class="plan-selection-title text-center">Your Path to a World Class Education Begins Here</div>

                        <!-- update premium packages -->
                        <div id="_getstarted_premium_plans">
                            <div class="plan Basic">
                                <div class="name Basic">Basic</div>
                                <div class="feature">
                                    <div>Research Colleges</div>
                                </div>
                                <div class="feature">
                                    <div>Connect with Colleges</div>
                                </div>
                                <div class="feature">
                                    <div>Track which Colleges viewed you</div>
                                </div>
                                <div class="feature">
                                    <div>Send messages</div>
                                </div>
                                <div class="feature">
                                    <div>Chat with Colleges</div>
                                </div>
                                <div class="text-center">
                                    <a class="choose disabled"><span>Current Plan</span></a>
                                </div>
                            </div>
                            ...
                            <div class="plan Premium">
                                ...
                                <div class="price">
                                    <div class="amt">
                                        ...
                                        99
                                        <div class="wp">with Plexuss</div>
                                    </div>
                                </div>
                                <div class="feature">
                                    <div><b>Apply to 10</b> select universities for FREE</div>
                                    <div class="savings">Savings of $125-375</div>
                                </div>
                                <div class="feature">
                                    <div><b>1-on-1 meeting</b> with a professional advisor</div>
                                    <div class="savings">Savings of $200</div>
                                </div>
                                <div class="feature">
                                    <div><b>Review 20 essays</b> from accepted students to top US universities</div>
                                </div>
                                <div class="text-center">
                                    <a href="/checkout/premium" class="choose"><span>Choose Plan</span></a>
                                </div>
                                <div class="savings total">Total Savings of $325-575</div>
                            </div>

                            <div class="plan Premium Plus">
                                <div class="name Premium Plus">Premium Plus</div>
                                <div class="price">
                                    <div class="amt">
                                        <div class="dollar">$</div>
                                        199
                                ...
                                <div class="feature">
                                    <div><b>Apply to 20</b> select universities for FREE</div>
                                    <div class="savings">Savings of $350-750</div>
                                </div>
                                <div class="feature">
                                    <div><b>1-on-1 meeting</b> with a professional advisor</div>
                                    <div class="savings">Savings of $200</div>
                                ...
                                <div class="feature">
                                    <div><b>Review 50 essays</b> from accepted students to top US universities</div>
                                </div>
                                <div class="text-center"><a href="/checkout/premium-plus" class="choose"><span>Choose Plan</span></a></div>
                                <div class="savings total">Total Savings of $550-950</div>
                            </div>
                        </div>
                        <!-- update premium packages -->
                    ...
                    <div class="manage-subscription-container">
                        ...
                        <div class="row">
                            ...
                            <div class="column small-6 show-for-small-only text-right">
                                <button class="edit-payment-btn">Edit Payment Info</button>
                            </div>
                            <div class="column small-12 medium-6 small-text-left medium-text-right">
                                <input type="checkbox" id="auto_renew" class="autorenew" checked="checked">
                                <label for="auto_renew">Auto renew (renews every month)</label>
                            </div>
                        </div>
                    </div>

                    <div class="billing-info" data-is-premium="{{$premium_user_level_1 or 0}}">
                        <div class="row collapse payment-row">
                            <div class="column large-5">
                                <span class="payment-title">Name and Address : </span>
                                <ul>
                    ...
                    <div class="billing-checkout">
                        ...
                        <div class="summary-list">
                            <div class="summary-item">
                                <div class="item-descrip clearfix">
                                    <div class="left"><b>Premium</b></div>
                                    <div class="right">One time fee</div>
                                </div>
                                <div class="item-package clearfix">
                                    <div class="left">Plexuss Premium Membership</div>
                                    <div class="right"><b>$100.00</b></div>
                                </div>
                            </div>
                    ...
                    <div class="billing-done text-center">
                        ...
                        <div class="msg">Congratulations on becoming a <b>premium member</b>! You will now stand out to colleges among the other basic members.</div>
                        <br />
                        <div class="msg">A confirmation email has been sent to <u><span class="billing-email"></span></u> for your record. This order will also be viewable in your Invoice History.</div>
                        <a href="/portal">{{Form::submit('Get Started', array('class' => 'submit', 'id' => 'get-started-w-plex'))}}</a>
                        <div class="manage-sub-btn"><a href="/settings/billing">Manage Subscription</a></div>
                    </div>
                </div>
