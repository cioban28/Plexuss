...
<div id="manage-school-div">                        
    ...
    <div class="row portal_header-mid">
            ...
            <thead>
            <tr>
            <th>  <input type="checkbox" name="del_chk" id="del_chk"  class="checkall" /></th>
            <th width="15%">SORT</th>
            ...
            <span class="c79 fs12 d-block">                      	                        
                ...
                <span class="cursor" onclick="Opendiv(this);">
                    quick facts 
...
var global_listdata = '<?php echo json_encode((array)$data['listdata'])?>';
global_listdata = $.parseJSON(global_listdata);
...
$(global_listdata).each(function(index, element) {
	 var parTr = $("#trrow_"+element.list_id)	
	/*	var return_val='<tr class="subtr d-none"><td colspan="6">'+
	 '<div class="row">'+
	 	'<div class="small-4 column no-padding">'+
			'<div class="row">'+
				'<div class="small-8 column no-padding c79 fs10">Admission Deadline:</div>'+
				'<div class="small-4 column no-padding c79 fs9">'+element.list_id+'</div>'+
			'</div>'+
			'<div class="row">'+
				'<div class="small-8 column no-padding c79 fs10">Grauation Rate:</div>'+
				'<div class="small-4 column no-padding c79 fs9"></div>'+
			'</div>'+
			'<div class="row">'+
				'<div class="small-8 column no-padding c79 fs10">Student-Teacher Ratio:</div>'+
				'<div class="small-4 column no-padding c79 fs9">'+element.student_faculty_ratio+'%</div>'+
			'</div>'+
			'<div class="row">'+
				'<div class="small-8 column no-padding c79 fs10">In-state Tuition:</div>'+
				'<div class="small-4 column no-padding c79 fs9">$'+element.tuition_avg_in_state_ftug+'</div>'+
			'</div>'+
			'<div class="row">'+
				'<div class="small-8 column no-padding c79 fs10">Out-state Tuition:</div>'+
				'<div class="small-4 column no-padding c79 fs10">$'+element.tuition_avg_out_state_ftug+'</div>'+
			'</div>'+
			'<div class="row">'+
				'<div class="small-8 column no-padding c79 fs10">Student Body Size:</div>'+
				'<div class="small-4 column no-padding c79 fs9">'+element.student_body_total+'</div>'+
			'</div>'+
			'<div class="row">'+
				'<div class="small-8 column no-padding c79 fs10">Athletics:</div>'+
				'<div class="small-4 column no-padding c79 fs10">'+element.class_name+'</div>'+
			'</div>'+
		 '</div>'+
		 '<div class="small-4 column no-padding">'+
		 	'<div class="row">'+
				'<div class="small-8 column no-padding c79 fs10 f-blod">AVERAGE SAT SCORE:<br /><span class="fs9 f-normal">25th - 75th Percentile</span></div>'+
				'<div class="small-4 column no-padding c79 fs9"><img src="/images/portal/score.png"></div>'+
			'</div>'+
		 '</div>'+
		 '<div class="small-4 column no-padding">'+
		 	'<div class="row">'+
