<div id="manage-school-div">                        
    <div class="portal_header-div row pos-rel">
     <!---------------------------------------- header menu in mobile view ---------------------------------------->           
    	<div class="show-for-small-only">
            ...
            <div class="row pt10">
            	<div class="small-7 column c-black no-padding fs13" style="margin-left:-5px;">SCHOOLS THAT WANT YOU</div>
      ...
      <!---------------------------------------- header menu in mobile view ---------------------------------------->     
        <div class="small-6 column no-padding fs21 f-bold clr-green show-for-medium-up">SCHOOLS THAT WANT TO RECRUIT YOU</div>
    ...
    <div class="portal_header_nav show-for-medium-up">                      
        <ul>
            ...
            <li onclick="selectCheckbox('trashschool')"><img src="/images/nav-icons/trash-small.png" onclick="selectCheckbox('trashschool')"> MOVE TO TRASH</li>
    ...
    <div class="row portal_header-mid">
            <div class="medium-3 small-3 column portal-content-left-side no-padding show-for-medium-up">
                <ul class="left-nav">
                    ...
                    <li onclick="loadPortalTabs('manageschool','menu2')" class="left-nav-li-active">
                 ...
                 @foreach($listdata as $key=>$keyval)                
                   <tr id="trrow_{{$keyval->list_id}}">
                        <td align="center" valign="top">
                        	<input type="checkbox" name='check_group' value='{{ $keyval->list_id or ''}}' class="check_group"/>
                        </td>
                        <td class="show-for-medium-up" valign="top">
                            <div class="row pt10">                                                	
                                    ...
                                    <div class="fr rank f-bold">#1</div>
                                    <div class="clear"></div>
                            </div>
                        </td>
                        <td valign="top">
                            <div class="row">
                                ...
                                <div class="small-12 medium-9 column no-padding pl5">
                                   <span class="c-blue fs14 f-bold"><a href="/college/{{$keyval->id}}">{{$keyval->school_name}}</a></span>
                                    <span class="c79 fs12 d-block mt10 l-hght18">                      	                        
                                        {{$keyval->city}}, {{$keyval->long_state}}  |  
                                         <span class="cursor" onclick="Opendiv(this,'<?php echo $keyval->list_id.'-'.$keyval->tablename?>','manageschool','menu2');">
                                            quick facts 
                 ...
                 <div class="floating-header-mobile">  
                    <ul>
                       <li onclick="loadPortalTabs('manageschool','menu1')"><img src="/images/nav-icons/list.png"></li>
                    	<li onclick="loadPortalTabs('manageschool','menu2')" class="mobile-menu-nav-active"><img src="/images/nav-icons/recurit.png"> <div class="badge">10</div> </li>
