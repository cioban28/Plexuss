...
<div class="row">
	<div id="profileUnlockmodal" class="reveal-modal column" data-reveal>
		<div class='row'>
			<div class='large-centered large-12 column'>
				<h3>Unlock your recruitment tools...</h3>
				<p class="lead">In order to use our recruitment tools, we need this key information from you. Just a few questions that are necessary to get started.</p>
			</div>
		</div>
	...
	<div class="row">
		...
		{{ Form::hidden('ajaxtoken', $ajaxtoken , array()); }}
		...
		<div class='large-centered large-12 column'>
			...
			<div id='ft_modal_student' class='row ft_modal_container'>
				<div class='small-12 column'>
					...
					<div id='student_zipcode_container' class='row collapse ftm_student'>
						...
						<div class='large-8 column end'>
							{{ Form::text('student_zipcode', null, array('id' => 'student_zipcode', 'class' => 'ft_zipcode ft_reset', 'placeholder' => 'Zipcode', 'pattern' => 'zip', 'maxlength' => '10')) }}
					...
					<div id="student_school_name_container" class="row collapse ft_school_name_container ftm_student">
						...
						<div class='large-8 column end ui-front'>
			...
			<div id='ft_modal_alumni' class='row ft_modal_container'>
				<div class='small-12 column'>
					...
					<div id='alumni_zipcode_container' class='row collapse ftm_alumni'>
						...
						<div class='large-8 column end'>
							{{ Form::text('alumni_zipcode', null, array('id' => 'alumni_zipcode', 'class' => 'ft_zipcode ft_reset', 'placeholder' => 'Zipcode', 'pattern' => 'zip', 'maxlength' => '10')) }}
							<small class="error">You need to add your zipcode to help locate school near you.</small>
						</div>
					</div>
					<!-- LEVEL OF EDUCATION -->
			...
			<div id='ft_modal_parent' class='row ft_modal_container'>
				<div class='small-12 column'>
					...
					<div id='parent_zipcode_container' class='row collapse ftm_parent'>
						...
						<div class='large-8 column end'>
							{{ Form::text('parent_zipcode', null, array('id' => 'parent_zipcode', 'class' => 'ft_zipcode ft_reset', 'placeholder' => 'Zipcode', 'pattern' => 'zip', 'maxlength' => '10')) }}
							<small class="error">You need to add your zipcode to help locate school near you.</small>
						</div>
					</div>
					<!-- LEVEL OF EDUCATION -->
			...
			<div id='ft_modal_counselor' class='row ft_modal_container'>
				<div class='small-12 column'>
					...
					<div id='counselor_zipcode_container' class='row collapse ftm_counselor'>
						...
						<div class='large-8 column end'>
							{{ Form::text('counselor_zipcode', null, array('id' => 'counselor_zipcode', 'class' => 'ft_zipcode ft_reset', 'placeholder' => 'Zipcode', 'pattern' => 'zip', 'maxlength' => '10')) }}
							<small class="error">You need to add your zipcode to help locate school near you.</small>
						</div>
					</div>
					<!-- LEVEL OF EDUCATION -->
			...
			<div class='row '>
				<div class='large-push-4 large-4 column homepageSkipQuestions'>
					@if ( !isset($RecruitCollegeId) )
						<div class="btn-cancel">
							<a class="" href="/home">Skip this question and answer later</a>
						</div>
					@endif
