...
--}}
        {{-- Plexuss Mobile Ad --}}
        <div class="owl-carousel owl-theme"><div id="slide1" class="frontpage-top-content-banner-back custSlider item green-bg">
		@endif
			<div class="row collapse frontpage-content-banner-row">
              ...
              <!--   <div class="row i-want-to-mobile-container show-for-small-only" data-reveal-id="i-want-to-modal">I want to <span class="navigation-arrow-dropdown-big">&nbsp;</span></div> -->

                @include('includes.iWantToMobileModal')
				<!-- opening college recruitment welcome section -->
				<div id="frontpage_opening_side_bar_section" class="column large-12 frontpage-side-bar-sections" style="">

                    <div class="plexuss-mobile-ad-frontpage-left-side small-12">
                        <div class="homepage-plexuss-quote"><nobr>We help you reach</nobr> <nobr>your goals as</nobr> <nobr>a student</nobr></div>
												 @if( !isset($signed_in) || $signed_in != 1 )
	                      <a href="/signup?utm_source=SEO&utm_medium=frontPage_center"><div class='homepage-signup-button'>Sign up</div></a>
												<div class='row fb-login-container hide-for-large-up'>
														<a href="/facebook?utm_source=SEO&utm_medium=signupPage" class='signup-fb'>Sign up with Facebook</a>
												</div>
												<a href="/signin" class='homepage-signin hide-for-large-up' style="padding-bottom: 0.2em;">Sign in</a>
                    ...
                    <div class="plexuss-mobile-ad-frontpage-right-side small-12">
                        <div class="hover-circles">
	                        ...
	                        <div><img class="frontpage-circle-img left-circle" src="https://s3-us-west-2.amazonaws.com/asset.plexuss.com/frontpage/frontpage-left-circle.png"></div>
	                        <div><img class="frontpage-circle-img right-circle" src="https://s3-us-west-2.amazonaws.com/asset.plexuss.com/frontpage/frontpage-right-circle.png"></div>
												</div>
                    ...
                    <div class='circle-clicked-overlay right-circle-overlay'>
					 ...
					 <!-- //enable for webinar  -->
					<!-- <div class="plex-sign-up hide-for-small-only text-center" style="margin: 0;">
						<a href="/signup?utm_source=SEO&utm_medium=frontPage&utm_term=middle"><div class="sign-up-btn">Sign up for free!</div></a>
					</div> -->
						...
						<div class="column small-11 small-centered show-for-small-only">
							<div class="row">
			                	<div class="columns small-12">
			                		<a href="/webinar?utm_source=SEO&utm_medium=frontPage&utm_term=middle">
			                			<img src="https://s3-us-west-2.amazonaws.com/asset.plexuss.com/frontpage/liberty-march1-frontpage-signup.png" alt="Webinar Sign Up">
			                		</a>
			                	</div>
			                </div>
			            </div>
...
<script>
		...
		function showDivs(n) {
		  var i;
		  var x = document.getElementsByClassName("custSlider");
		  var dots = document.getElementsByClassName("demo");
		  if (n > x.length) {slideIndex = 1}
		  if (n < 1) {slideIndex = x.length}
		  for (i = 0; i < x.length; i++) {
		     x[i].style.cssText = "display: none !important;";
				 //x[i].onclick = function() {currentDiv(slideIndex+1); };
		  }
		  for (i = 0; i < dots.length; i++) {
		     dots[i].className = dots[i].className.replace("pdept-white", "");
		  }
		  x[slideIndex-1].style.cssText = "display: block !important;";
