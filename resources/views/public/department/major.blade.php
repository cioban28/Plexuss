  ...
  <div class="right-bar-department-info">
    <div class="row">
          <h1 class="department-headning-div">
            <a href="/college-majors/{{ $selected }}">{{ $metainfo->department_category }}</a> > {{  $metainfo->name }}
          </h1>
          <div class="department-header-img">
              <img src="https://s3-us-west-2.amazonaws.com/asset.plexuss.com/major/header/{{ $metainfo->header_img_name }}" alt="{{ $metainfo->header_image_alt }}" class="full-width" />
			    </div>
      </div>
      <div class="row">
          <h1 class="department-headning-div">
      ...
      <div class="row" style="margin-top: -13px !important;">
        <div class="department-header-img">
            <img src="https://s3-us-west-2.amazonaws.com/asset.plexuss.com/major/images/{{ $metainfo->body_img1_name }}" alt="{{ $metainfo->body_img1_alt }}" class="full-width" />
        </div>
      </div>
      <div class="row">
          <h1 class="department-headning-div">
