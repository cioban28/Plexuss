								...
								<div class="row">
									<div class="column small-12 medium-12 large-11 end">
										<div class="row scores">
											...
											<div class="score column small-3 text-center">
						...
						<div class="column small-12 medium-12 large-5 personal-students-notes-column">
							...
							<div class="row">
								<div class="column small-12 question-container">
									...
									<div class="row c-info">
										<div class="column large-4 small-3">
											<div class="contact-verify  @if(isset($key['phonecall_verified']) && $key['phonecall_verified']) verified @endif" id="phonecallc">
									...
									<div class="row c-info">
										<div class="column large-4 small-3">
											<div class="contact-verify  @if(isset($key['verified_phone']) && $key['verified_phone']) verified @endif" id="phonec">
							...
							<div class="row noteContainer-s">
								...
								<div class="column small-10 textarea-col">
									...
									<textarea class="plexuss-notes-textarea" name="studentNotes" cols="5" rows="2" data-studentid="{{$key['student_user_id']}}">{{$plexuss_note or ''}}</textarea>

									<div class="last-saved-note-time">
										@if( isset($plexuss_note) && !empty($plexuss_note) )
										Last Saved: <span class="note-time-updated">{{$plexuss_note_updated_at or '--:--'}}</span>
										@endif
									</div>
