    ...
    <div class="banner">
      <div class="row">
         <div class="banner-caption">
          ...
          <h3>Guaranteed I-20 or your money back.</h3>
        </div>
        <div align="right">
          @if($signed_in == 1)
    ...
    <div class="one-on-one-block">
      <div class="row">
        <div class="large-12 medium-12 columns">
          <p>
            Offering a world-class education, improved career prospects after graduation, and a potential pathway for immigration - the United States continues to be the most popular study abroad destination for Indian students. Whether you’re interested in computer science, business, or engineering, we have more than 100 partner universities who can provide you the education that you’re looking for.</p>
          ...
          <div align="center">
            ...
            @elseif(isset($showSignUp) && $showSignUp == 0)
            <a href="/signin{{$utm_source}}&utm_medium={{$utm_medium}}_get-one-to-one-support-today{{$utm_campaign}}{{$utm_content}}&redirect=checkout/premium{{$utm_term}}" class="button one-on-one-btn">Get One-on-One Support Today</a>
            @else
            <a href="/signup{{$utm_source}}&utm_medium={{$utm_medium}}_get-one-to-one-support-today{{$utm_campaign}}{{$utm_content}}&redirect=/get_started/9{{$utm_term}}" class="button one-on-one-btn">Get One-on-One Support Today</a>
            @endif
          </div>
        </div>
      </div>
    ...
    <div class="post-area">
      <div class="row post">
        <div class="large-6 medium-6 small-12 columns post-textarea">
          ...
          <div class="mobile-text-p">
            ...
            @if($signed_in == 1)
            <a href="/checkout/premium" class="button custom-btn">Guarantee University Acceptance</a>
            @elseif(isset($showSignUp) && $showSignUp == 0)
            <a href="/signin{{$utm_source}}&utm_medium={{$utm_medium}}_guarantee-university-acceptance{{$utm_campaign}}{{$utm_content}}&redirect=checkout/premium{{$utm_term}}" class="button custom-btn">Guarantee University Acceptance</a>
            @else
            <a href="/signup{{$utm_source}}&utm_medium={{$utm_medium}}_guarantee-university-acceptance{{$utm_campaign}}{{$utm_content}}&redirect=/get_started/9{{$utm_term}}" class="button custom-btn">Guarantee University Acceptance</a>
            @endif
          </div>
        </div>
      ...
      <div class="row post">
        ...
        <div class="large-6 medium-6 small-12 columns post-textarea post-left-text">
          <h3>Free College Applications</h3>
           ...
           <div class="mobile-text-p">
            <p>Most application fees range from ₹3,700-7,400 each, but with Plexuss Premium you are given 5 applications to select universities in our network for free, saving you an additional ₹18,350.
            </p>
            @if($signed_in == 1)
            <a href="/checkout/premium" class="button custom-btn">Save ₹18,350 in Application Fees</a>
            @elseif(isset($showSignUp) && $showSignUp == 0)
            <a href="/signin{{$utm_source}}&utm_medium={{$utm_medium}}_save-application-fees{{$utm_campaign}}{{$utm_content}}&redirect=checkout/premium{{$utm_term}}" class="button custom-btn">Save ₹18,350 in Application Fees</a>
            @else
            <a href="/signup{{$utm_source}}&utm_medium={{$utm_medium}}_save-application-fees{{$utm_campaign}}{{$utm_content}}&redirect=/get_started/9{{$utm_term}}" class="button custom-btn">Save ₹18,350 in Application Fees</a>
            @endif
      ...
      <div class="row post">
        <div class="large-6 medium-6 small-12 columns post-textarea">
          ...
          <div class="mobile-text-p">
            <p>Receive one-on-one support over the next few months as you prepare for college, including help filling out your applications and understanding what documents you will need to include. These services are often provided by agents at a cost of ₹18,350+ but with Plexuss Premium you get the same support plus the free applications and access to admissions essays for $499 total.
            </p>
            @if($signed_in == 1)
            <a href="/checkout/premium" class="button custom-btn">Get Accepted to Top US University</a>
            @elseif(isset($showSignUp) && $showSignUp == 0)
            <a href="/signin{{$utm_source}}&utm_medium={{$utm_medium}}_get-accepted-to-top-us-uni{{$utm_campaign}}{{$utm_content}}&redirect=checkout/premium{{$utm_term}}" class="button custom-btn">Get Accepted to Top US University</a>
            @else
            <a href="/signup{{$utm_source}}&utm_medium={{$utm_medium}}_get-accepted-to-top-us-uni{{$utm_campaign}}{{$utm_content}}&redirect=/get_started/9{{$utm_term}}" class="button custom-btn">Get Accepted to Top US University</a>
            @endif
          </div>
        </div>
      ...
      <div class="row study-abroad-block">
        <h1>You Deserve the Best Study Abroad Experience</h1>
        <h3>The Plexuss Premium Promise:</h3>
        <ul class="premium-promise-list">
          <li>
            <span class="promise-tick"><img src="/css/PremiumIndia/images/checkmark.png"></span>
            <p class="promise-text">$499 Service Fee- Get Accepted to a U.S. University or Your <span class="green-color">Money Back*<span></p>
          </li>
          <li>
            <span class="promise-tick"><img src="/css/PremiumIndia/images/checkmark.png"></span>
            <p class="promise-text">Guaranteed I-20 Form for Your Visa Application within 12 Months</p>
          </li>
          <li>
            <span class="promise-tick"><img src="/css/PremiumIndia/images/checkmark.png"></span>
            <p class="promise-text">One-on-one University Admission Assistance Personalized to Meet Your Goals</p>
          </li>
          <li>
            <span class="promise-tick"><img src="/css/PremiumIndia/images/checkmark.png"></span>
          ...
          <li>
            <span class="promise-tick"><img src="/css/PremiumIndia/images/checkmark.png"></span>
            <p class="promise-text">Expert Support Helping You Choose a School in the USA or the UK</p>
          </li>
          <li>
            <span class="promise-tick"><img src="/css/PremiumIndia/images/checkmark.png"></span>
            <p class="promise-text">Five FREE College Applications and Access to Exclusive Scholarships to Select Universities</p>
          </li>
        </ul>
        <div align="center">
          @if($signed_in == 1)
          <a href="/checkout/premium" class="button one-on-one-btn">Get One-on-One Support Today</a>
          @elseif(isset($showSignUp) && $showSignUp == 0)
          <a href="/signin{{$utm_source}}&utm_medium={{$utm_medium}}_get-one-to-one-support-today-bottom{{$utm_campaign}}{{$utm_content}}&redirect=checkout/premium{{$utm_term}}" class="button one-on-one-btn">Get One-on-One Support Today</a>
          @else
          <a href="/signup{{$utm_source}}&utm_medium={{$utm_medium}}_get-one-to-one-support-today-bottom{{$utm_campaign}}{{$utm_content}}&redirect=/get_started/9{{$utm_term}}" class="button one-on-one-btn">Get One-on-One Support Today</a>
          @endif
        </div>
      </div>
      <div class="checkmark-bottom-text">*The $499 fee only applies to the Plexuss Premium Service. Tuition fees required by the college and living expenses are not covered and will be the responsibility of the student.</div>
    </div>
    <div class="comments-block">
      <div class="row">
        <div class="large-12 columns text-center students-head ">
          <h1>Don't take our word for it...</h1>
          <h3>See what students and colleges have to say:</h3>
        </div>
      </div>
            ...
            <div class="card-dimensions">
              <div class="card card-style">
                  <div class="card-text-section">
                    <p> "I found Plexuss while Googling... Once you are a member of Plexuss, they consider it their responsibility to help you... If you need information about any school any where in the USA, Plexuss will definitely help you a lot."</p>
                  </div>
                    ...
                    <div class="image-frame">
                      <div class="user-image">
                        ...
                        <div class="flag-image">
                          <img src="/css/PremiumIndia/images/2000px-Flag_of_Bangladesh.jpg" class="profile-image2">
                        </div>
                      </div>
                    </div>
                    <div class="info-block">
                      <div class="info-head">
                        <a class="title" href="#">Alve Chowdhury </a>
                        <span class="country-name">from Bangladash</span>
                      </div>
                      <p>Applied to Northeastern University
                          texas A&M University and Adelphi University</p>
                    </div>
            ...
            <div class="card-dimensions">
              <div class="card card-style">
                  ...
                  <div class="user-block">
                    ...
                    <div class="info-block">
                      <div class="info-head">
                        <a class="title" href="#">Evan Saber </a>
                        <span class="country-name">from Kirkuk, Iraq</span>
                      </div>
                      <p>Interested in University of Arkansas, University of Illinois-Chicago</p>
                    </div>
            ...
            <div class="card-dimensions">
              <div class="card card-style">
                  ...
                  <div class="user-block">
                    ...
                    <div class="info-block">
                      <div class="info-head">
                        <a class="title" href="#">Richard O'Rourke</a>
                        <span class="country-name">University of Illinois at Chicago</span>
                      </div>
                      <p>Associate Director Office of Admission Recruitment and Outreach</p>
                    </div>
                  </div>
              </div>
            </div>
            ...
            <div class="card-dimensions">
              <div class="card card-style">
                  ...
                  <div class="user-block">
                    ...
                    <div class="info-block">
                      <div class="info-head">
                        <a class="title" href="#">Emily Kirsch</a>
                        <span class="country-name">Humboldt State University</span>
                      </div>
                      <p>International Marketing and Recruitment Coordinator</p>
                    </div>
                  </div>
              </div>
            </div>
