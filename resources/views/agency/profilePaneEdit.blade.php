									...
									<div class="row">
										...
										<div class="column small-12 question-container edit-contact-container">
											...
											<div class="row e-c-info">
												...
												<div class="column large-8 small-9 link-cont">
													<input type="text" pattern="address" name="address" value="{{$key['userAddress'] or 'Address'}}" />
											...
											<div class="row e-c-info">
												...
												<div class="column large-8 small-9 link-cont">
													<input type="text" pattern="city" name="city" value="{{$key['userCity'] or 'City'}}" />
											...
											<div class="row e-c-info">
												...
												<div class="column large-8 small-9 link-cont">
													<input type="text" pattern="state" name="state" value="{{$key['userState'] or 'State'}}"  />
