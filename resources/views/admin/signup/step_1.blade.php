...
<div class='row'>
	<div class='large-12 column'>
		{{ Form::text('email', null, array('id' => 'email', 'placeholder'=>'john.doe@university.edu', 'required', 'pattern'=>'email')) }}
...
<div class='row'>
	<div class='admin-agreement-checkbox large-12 column'>
		<input id='admin-agreement-check-step-1' class='agreement-checkbox' type='checkbox' required />
		<label for='admin-agreement-check-step-1'>I agree to the Plexuss <a target='_blank' href='/terms-of-service'><u>terms of service</u></a> & <a target='_blank' href='/privacy-policy'><u>privacy policy</u></a></label>
	</div>
</div>
<div class='row'>
	<div class='large-12 column'>
...
<div class='row' style='text-align: center'>
    <div class='login-button' onclick='window.location="/signin?utm_source=admin-signup"'>Already have an account? Log in</div>
</div>
{{ Form::close() }}