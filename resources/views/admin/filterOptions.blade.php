...
<div id="filter-options" class="row student-search-container" data-admin-type="{{$adminType or ''}}">
    <div class="column small-12 medium-12 large-12 search-sidebar-container">
        ...
        @if(( isset($is_aor) && $is_aor == 1 ) || ($is_plexuss == 1 && $org_school_id == 7916))
            <li data-search-tab="hasApplied" class="search-tab">
                <div class="change-icon hide">&#x02713;</div>
                <a href="">Has Applied</a>
                <div class="search-filter-form">
                   
                    <div class="component hasApplied">
                        <div class="row">
                            <div class="column small-12 mt20 mb20">
                                <div class="select-container">
                                    <div class="applied-form">
                                        <input id="_hasApplied" type="text" class="form-field" data-type="text" placeholder="Enter school name" />
                                        <ul id="_hasApplied_results"></ul>
                                    </div>

                                    <div class="tag-list clearfix for-applied">
                                        <!-- tags injected here -->   
                                    </div>
                                </div>
                            </div>
        ...
        @if(isset($is_plexuss) && $is_plexuss == 1)
            <li data-search-tab="contactStat" class="search-tab">
                <div class="change-icon hide">&#x02713;</div>
                <a href="">Contact Status</a>
                <div class="search-filter-form">
                   
                    <div class="component contactStat">
                        <div class="row">
                            <div class="column small-12 mt20 mb20">
                               
                                <!-- <input name="contact[]" id="notCall" class="contact-stat" value="notCalled" type="checkbox"/>
                                <label for="notCall"> 
                                    Have not called
                                </label><br/> -->
                                
                                
                                <input name="contact[]" id="veriTxt" class="contact-stat" value="verifiedText" type="checkbox"/>
                                <label for="veriTxt"> 
                                    Verified Text
                                </label>
                            </div>
        ...
        @endif
            <li data-search-tab="followStat" class="search-tab">
                <div class="change-icon hide">&#x02713;</div>
                <a href="">Follow Up Status</a>
                <div class="search-filter-form">
                   
                    <div class="component followStat">
                        <div class="row">
                            <div class="column small-12 mt20 mb20">
                                
                                <input name="interview[]" id="Has_not scheduled prescreen" class="interview-stat" value="Has not scheduled prescreen" type="checkbox"/>
                                <label for="Has_not_scheduled_prescreen">
                                Has not scheduled prescreen
                                </label><br/>

                                <input name="interview[]" id="Attempted_phone_contact" class="interview-stat" value="Attempted phone contact" type="checkbox"/>
                                <label for="Attempted_phone_contact">
                                    Attempted phone contact
                                </label><br/>

                                <input name="interview[]" id="Requested_callback" class="interview-stat" value="Requested callback" type="checkbox"/>
                                <label for="Requested_callback">
                                Requested callback
                                </label><br/>

                                <input name="interview[]" id="Not_Scheduled_Interview" class="interview-stat" value="Not Scheduled Interview" type="checkbox"/>
                                <label for="Not_Scheduled_Interview">
                                    Not Scheduled Interview
                                </label><br/>

                                <input name="interview[]" id="Scheduled_Interview" class="interview-stat" value="Scheduled Interview" type="checkbox"/>
                                <label for="Scheduled_Interview">
                                    Scheduled Interview
                                </label><br/>

                                <input name="interview[]" id="Interview_did_not_Happen" class="interview-stat" value="Interview did not Happen" type="checkbox"/>
                                <label for="Interview_did_not_Happen">
                                    Interview did not Happen
                                </label><br/>

                                <input name="interview[]" id="Not_interested_in_premium" class="interview-stat" value="Not interested in premium" type="checkbox"/>
                                <label for="Not_interested_in_premium">
                                    Not interested in premium
                                </label><br/>

                                <input name="interview[]" id="Tentative_Commit_to_Premium" class="interview-stat" value="Tentative Commit to Premium" type="checkbox"/>
                                <label for="Tentative_Commit_to_Premium">
                                    Tentative Commit to Premium
                                </label><br/>

                                <input name="interview[]" id="Full_Commit_to_Premium" class="interview-stat" value="Full Commit to Premium" type="checkbox"/>
                                <label for="Full_Commit_to_Premium">
                                    Full Commit to Premium
                                </label><br/>
                                ...
                                <div class="select-container hidden">
                                    <div class="row">
                                        <div class="column small-9">
                                            {{ Form::text('name', '', array('class' => 'form-field', 'data-type' => 'text', 'pattern'=>'nameemail', 'placeholder'=>'Please input name or email', 'style' => 'margin: 0 auto;'))}}
            ...
            <li data-search-tab="recruitmentstatus" class="search-tab">
                <div class="change-icon hide">&#x02713;</div>
                <a href="">Status</a>
                <div class="search-filter-form">
                    <div class="component clearfix recruitmentstatus">
                        <div class="s-label">Recruitment Status:</div>
                        {{ Form::checkbox('applied', '1' , false, array('id' => 'applied-filter', 'class' => 'form-field', 'data-type' => 'checkbox'))}}
                        {{ Form::label('applied-filter', 'applied')}}
                        {{ Form::checkbox('enrolled', '1' , false, array('id' => 'enrolled-filter', 'class' => 'form-field', 'data-type' => 'checkbox'))}}
                        {{ Form::label('enrolled-filter', 'enrolled')}}
                    </div>
                </div>
            </li>
