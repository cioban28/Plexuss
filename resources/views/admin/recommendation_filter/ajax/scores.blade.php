		...
		{{Form::open(array('url' => '', 'data-abide' => 'ajax'))}}
			...
			@if( isset($filters) && !empty($filters) )
				...
				<div class="row collapse component" data-component="Hs gpa">
					...
					<div class="column small-3 medium-2 large-3">
						...
						<small class="error">Incorrect values. Make sure Min GPA isn't greater than Max GPA.</small>
					</div>
				...
				@if( $gpa_M != null )
					<div class="column small-3 medium-2 large-3 end">
						...
						<small class="error">Incorrect values. Ex: 2.5 - 4.0</small>
					</div>
				...
				<div class="row collapse component" data-component="SAT">
					...
					<div class="column small-3 medium-2 large-3">
						...
						<small class="error">Incorrect values. Make sure Min SAT isn't greater than Max SAT.</small>
					</div>
					<div class="column small-3 medium-1 text-center scores-desc">
						to
					</div>
				...
				@if( $sat_M != null )
					<div class="column small-3 medium-2 large-3 end">
						...
						<small class="error">Incorrect values. Ex: 1200 - 2200</small>
					</div>
				</div>
				@else
					<div class="column small-3 medium-2 large-3 end">
				...
				<div class="row collapse component" data-component="ACT">
					...
					<div class="column small-3 medium-2 large-3">
						...
						<small class="error">Incorrect values. Make sure Min ACT isn't greater than Max ACT.</small>
					</div>
					<div class="column small-3 medium-1 text-center scores-desc">
						to
					</div>
				...
				@if( $act_M != null )
					<div class="column small-3 medium-2 large-3 end">
						...
						<small class="error">Incorrect values. Ex: 20 - 32</small>
					</div>
				</div>
				@else
					<div class="column small-3 medium-2 large-3 end">
				...
				<div class="row collapse component" data-component="TOEFL">
					...
					<div class="column small-3 medium-2 large-3">
						...
						<small class="error">Incorrect values. Make sure Min TOEFL isn't greater than Max TOEFL.</small>
					</div>
					<div class="column small-3 medium-1 text-center scores-desc">
						to
					</div>
				...
				@if( $toefl_M != null )
					<div class="column small-3 medium-2 large-3 end">
						...
						<small class="error">Incorrect values. Ex: 50 - 100</small>
					</div>
				</div>
				@else
					<div class="column small-3 medium-2 large-3 end">
				...
				<div class="row collapse component" data-component="IELTS">
					...
					<div class="column small-3 medium-2 large-3">
						...
						<small class="error">Incorrect values. Make sure Min IELTS isn't greater than Max IELTS.</small>
					</div>
					<div class="column small-3 medium-1 text-center scores-desc">
						to
					</div>
				...
				@if( $ielts_M != null )
					<div class="column small-3 medium-2 large-3 end">
						...
						<small class="error">Incorrect values. Ex: 5 - 9</small>
					</div>
				</div>
				@else
					<div class="column small-3 medium-2 large-3 end">
