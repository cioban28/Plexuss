...
<div class="row filter-by-demographic-container filter-page-section" data-section="demographic">
	<div class="column small-12 large-6">
		...
		@if(isset($filters))
			@php $filter = $filters; @endphp
			
			
			<!-- filter by age -->
				<div class="row component" data-component="Age">
					<div class="column small-3 medium-1 scores-desc">
						{{Form::label('none', 'Age:', array('class' => 'make_bold'))}}
					</div>
					<div class="column small-3">
				{{Form::text('ageMin_filter', isset($filter['ageMin_filter']) ? $filter['ageMin_filter'] : null, array('id' => 'ageMin_filter', 'class' => 'text-filter filter-this age', 'placeholder' => 'Min', 'data-scores' => 'min', 'pattern' => 'age'))}}
				...
				{{Form::text('ageMax_filter', isset($filter['ageMax_filter']) ? $filter['ageMax_filter'] : null, array('id' => 'ageMax_filter', 'class' => 'text-filter filter-this age', 'placeholder' => 'Max', 'data-scores' => 'max', 'pattern' => 'age'))}}
				...
				<div class="row contains-tags-row component" data-component="Gender">
					<div class="column small-12">
						...
						{{Form::radio('gender', 'all',isset($filter['gender']) ? false: true, array('id' => 'all_gender_filter', 'class' => 'radio-filter filter-this gender'))}}
						{{Form::label('all_gender_filter', 'All')}}
						<br class="show-for-small-only" />

						{{Form::radio('gender', 'include_gender', isset($filter['gender']) && $filters['gender'] == 'male'  ? true: false, array('id' => 'male_only_filter', 'class' => 'radio-filter filter-this gender'))}}
						{{Form::label('male_only_filter', 'Males Only')}}
						<br class="show-for-small-only" />

						{{Form::radio('gender', 'exclude_gender', isset($filter['gender']) && $filters['gender'] == 'female'  ? true: false, array('id' => 'female_only_filter', 'class' => 'radio-filter filter-this gender'))}}
				...
				<div class="row contains-tags-row component" data-component="Ethnicity">
					<div class="column small-12">
						...
						{{Form::radio('ethnicity', 'all', isset($filter['include_eth_filter_type']) ? false: true, array('id' => 'all_eth_filter', 'class' => 'radio-filter filter-this'))}}
						{{Form::label('all_eth_filter', 'All Ethnicities')}}
						<br class="show-for-small-only" />

						{{Form::radio('ethnicity', 'include', isset($filter['include_eth_filter_type']) && $filter['include_eth_filter_type'] == 'include'  ? true: false, array('id' => 'include_eth_filter', 'class' => 'radio-filter filter-this'))}}
						{{Form::label('include_eth_filter', 'Include')}}
						<br class="show-for-small-only" />

						{{Form::radio('ethnicity', 'exclude', isset($filter['include_eth_filter_type']) && $filter['include_eth_filter_type'] == 'exclude'  ? true: false, array('id' => 'exclude_eth_filter', 'class' => 'radio-filter filter-this'))}}
						...
						<div class="selection-row @if(!isset($filters['include_eth_filter_type'])) hideOnLoad @endif ">
							...
							@php $ethnicity = ''; @endphp
							@if(isset($filter['include_eth_filter']) && $filter['include_eth_filter'] > 0 )
								@foreach( $filter['include_eth_filter'] as $ethnicity1)
										@php $ethnicity = $ethnicity1; @endphp
									@endforeach
								
								@endif	
								
							{{Form::select('ethnicity_filter', $ethnicities, $ethnicity, array('id' => 'ethnicity_filter', 'class' => 'select-filter filter-this'))}}

							<!-- filter tags list -->
							<!--<div class="filter-tags-list">
								
								@if(isset($filter['include_eth_filter']) && $filter['include_eth_filter'] > 0 )
									@foreach( $filter['include_eth_filter'] as $ethnicity )
				...
				<div class="row contains-tags-row component" data-component="Religion">
					<div class="column small-12">
						...
						{{Form::radio('religion', 'all', isset($filter['include_rgs_filter_type']) ? false: true, array('id' => 'all_rgs_filter', 'class' => 'radio-filter filter-this'))}}
						{{Form::label('all_rgs_filter', 'All Religions')}}
						<br class="show-for-small-only" />

						{{Form::radio('religion', 'include', isset($filter['include_rgs_filter_type']) && $filter['include_rgs_filter_type'] == 'include'  ? true: false, array('id' => 'include_rgs_filter', 'class' => 'radio-filter filter-this'))}}
						{{Form::label('include_rgs_filter', 'Include')}}
						<br class="show-for-small-only" />

						{{Form::radio('religion', 'exclude', isset($filter['include_rgs_filter_type']) && $filters['include_rgs_filter_type'] == 'exclude'  ? true: false, array('id' => 'exclude_rgs_filter', 'class' => 'radio-filter filter-this'))}}
						...
						<div class="selection-row @if(!isset($filters['include_rgs_filter_type'])) hideOnLoad @endif ">
							...
							@php $religion = ''; @endphp
							@if(isset($filter['include_rgs_filter']) && $filter['include_rgs_filter'] > 0 )
									@foreach( $filter['include_rgs_filter'] as $religion1)
										@php $religion = $religion1; @endphp
									@endforeach
								
								@endif	
							{{Form::select('religion_filter', $religions, $religion , array('id' => 'religion_filter', 'class' => 'select-filter filter-this'))}}

							<!-- filter tags list -->
							<!--<div class="filter-tags-list">
								
								@if(isset($filter['include_rgs_filter']) && $filter['include_rgs_filter'] > 0 )
									@foreach( $filter['include_rgs_filter'] as $religion )
		...
		@else
			...
			<div class="row component" data-component="Age">
				...
				<div class="column small-3">
					{{Form::text('ageMin_filter', null, array('id' => 'ageMin_filter', 'class' => 'text-filter filter-this age', 'placeholder' => 'Min', 'data-scores' => 'min', 'pattern' => 'age'))}}
					<small class="error">Incorrect values. Make sure Min age isn't greater than Max age.</small>
				</div>
				...
				<div class="column small-3 end">
					{{Form::text('ageMax_filter', null, array('id' => 'ageMax_filter', 'class' => 'text-filter filter-this age', 'placeholder' => 'Max', 'data-scores' => 'max', 'pattern' => 'age'))}}
					<small class="error">Incorrect values. Ex: 16 - 30.</small>
				</div>
				<div class="column small-12 hide-for-large-up demo-age-desc">
					Choose an age range for students you are interested in. Students must be at least 13 years old to create an account on Plexuss.
			...
			<div class="row contains-tags-row component" data-component="Ethnicty">
				<div class="column small-12">
					...
					<div class="selection-row @if( empty($filter) ) hideOnLoad @endif">
						...
						{{Form::select('ethnicity_filter', $ethnicities, 'asian', array('id' => 'ethnicity_filter', 'class' => 'select-filter filter-this'))}}
			...
			<div class="row contains-tags-row component" data-component="Religion">
				<div class="column small-12">
					...
					<div class="selection-row @if( empty($filter) ) hideOnLoad @endif">
						...
						{{Form::select('religion_filter', $religions, '', array('id' => 'religion_filter', 'class' => 'select-filter filter-this'))}}
